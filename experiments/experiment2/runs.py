...
multi_subject_experiments = {
    ...
    11: {"train_list": [3, 7, 9, 10, 14, 20, 21, 24], "train_conditions": ["RP"], "experiment_name": "multiSubject"},
    ...
    16: {"train_list": [3, 7, 11, 15, 19, 23], "train_conditions": ["FW", "LW", "RW", "FP", "LP", "RP"], "experiment_name": "multiSubjectAll"}, #Later experiments
    17: {"train_list": [5, 9, 12, 16, 20, 24], "train_conditions": ["FW", "LW", "RW", "FP", "LP", "RP"], "experiment_name": "multiSubjectAll"}, #Later experiments
    18: {"train_list": [2, 8, 13, 18, 22, 25], "train_conditions": ["FW", "LW", "RW", "FP", "LP", "RP"], "experiment_name": "multiSubjectAll"}, #Later experiments
    19: {"train_list": [6, 10, 14, 17, 21, 12], "train_conditions": ["FW", "LW", "RW", "FP", "LP", "RP"], "experiment_name": "multiSubjectAll"}, #Later experiments
